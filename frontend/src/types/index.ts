...
export interface BitMSession {
  id?: string
  target_id: string
  target_name?: string
  target_url?: string
  status: 'pending' | 'connecting' | 'active' | 'authenticated' | 'closed'
  victim_ip?: string
  created_at?: string
...
export interface CapturedBitMData {
  id?: string
  session_id: string
  target_name: string
  target_url?: string
...
export interface BitMStats {
  total_targets: number
  total_sessions: number
  active_sessions: number
  authenticated_sessions: number
  total_captures: number
  captures_with_cookies: number
}
